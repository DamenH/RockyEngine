...
#define         PATH_PBR_VS                 "../media/Shaders/pbr.vs"              // Path to physically based rendering vertex shader
#define         PATH_PBR_FS                 "../media/Shaders/pbr.fs"              // Path to physically based rendering fragment shader
#define         PATH_CUBE_VS                "../media/Shaders/cubemap.vs"          // Path to equirectangular to cubemap vertex shader
#define         PATH_CUBE_FS                "../media/Shaders/cubemap.fs"          // Path to equirectangular to cubemap fragment shader
#define         PATH_SKYBOX_VS              "../media/Shaders/skybox.vs"           // Path to skybox vertex shader
#define         PATH_SKYBOX_FS              "../media/Shaders/skybox.fs"           // Path to skybox vertex shader
#define         PATH_IRRADIANCE_FS          "../media/Shaders/irradiance.fs"       // Path to irradiance (GI) calculation fragment shader
#define         PATH_PREFILTER_FS           "../media/Shaders/prefilter.fs"        // Path to reflection prefilter calculation fragment shader
#define         PATH_BRDF_VS                "../media/Shaders/brdf.vs"             // Path to bidirectional reflectance distribution function vertex shader 
#define         PATH_BRDF_FS                "../media/Shaders/brdf.fs"             // Path to bidirectional reflectance distribution function fragment shader
